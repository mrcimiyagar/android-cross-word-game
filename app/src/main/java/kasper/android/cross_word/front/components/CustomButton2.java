...
public class CustomButton2 extends CardView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        View contentView = LayoutInflater.from(context).inflate(R.layout.custom_button_2, null, false);
        contentView.setLayoutParams(new LayoutParams(CardView.LayoutParams.MATCH_PARENT, CardView.LayoutParams.MATCH_PARENT));
        ...
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CustomButton2, 0, 0);
            try {
